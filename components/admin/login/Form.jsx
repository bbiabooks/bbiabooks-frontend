...
const Form = ({ type, login, setLogin, submitting, handleSubmit, handleSignup }) => {
  return (
        ...
        <div className="glassmorphism w-full md:w-1/2 p-8 rounded-lg shadow-lg">
          <div className="mb-8">
            <h1 className="text-3xl font-bold">
              Your Gateway to Admin Control!
            </h1>
            <p className="text-gray-600 mt-2">
              Log in to access powerful tools and take control of your administrative tasks.
            </p>
          </div>
