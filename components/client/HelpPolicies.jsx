                ...
                <div className="mb-12 flex justify-start flex-col">
                    ...
                    <div className="px-4 min-w-full bg-white rounded-lg shadow-lg p-6">
                        <div>
                            ...
                            <p className="pb-4">
                                <strong>Note:</strong> Remember to keep your login credentials confidential and report any suspicious activities immediately to maintain the system's security and integrity. Enjoy using the BBIA Library System!
                            </p>
                        </div>
                    </div>
                </div>
